...
export default function ProjectChatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="w-[360px] sm:w-[400px] h-[500px] bg-surface/95 border border-border-subtle rounded-2xl shadow-2xl flex flex-col overflow-hidden backdrop-blur-md mb-4 animate-slide-up">
          {/* Header */}
      ...
      <button
        ...
        className="w-12 h-12 bg-elevated border border-accent/40 text-accent rounded-full flex items-center justify-center shadow-2xl hover:bg-accent/10 transition-all hover:scale-105 cursor-pointer"
        title="CHATBOT"
      >
        {isOpen ? (
